            ...
            <div className="hidden items-center gap-2 md:flex">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuItem onClick={() => (window.location.href = "/?view=notes")}>Notes</DropdownMenuItem>
                  <DropdownMenuItem onClick={() => (window.location.href = "/notes")}>Rough notes</DropdownMenuItem>
                  <DropdownMenuSeparator />
