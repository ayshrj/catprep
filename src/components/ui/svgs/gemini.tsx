...
const Gemini = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 296 298" fill="none">
    ...
    <g mask="url(#a)">
      ...
      <g filter="url(#e)">
        <path fill="currentColor" d="M194 10.5C172 82.5 65.5 134.333 22.5 135L144-66l50 76.5Z" />
      </g>
      <g filter="url(#f)">
        <path fill="currentColor" d="M190.5-12.5C168.5 59.5 62 111.333 19 112L140.5-89l50 76.5Z" />
      </g>
      <g filter="url(#g)">
        <path fill="currentColor" d="M194.5 279.5C172.5 207.5 66 155.667 23 155l121.5 201 50-76.5Z" />
      </g>
      <g filter="url(#h)">
        <path fill="currentColor" d="M196.5 320.5C174.5 248.5 68 196.667 25 196l121.5 201 50-76.5Z" />
      </g>
    </g>
    <defs>
      <filter
