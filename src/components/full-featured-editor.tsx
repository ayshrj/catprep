...
const PLACEHOLDER = "Press '/' for commands, or start typing to capture your thoughts.";
          ...
          <div className="flex min-h-0 flex-1 flex-col gap-4">
            ...
            <div className="relative min-h-0 flex-1">
              ...
              <ComponentPickerMenuPlugin
                ...
                dynamicOptionsFn={({ queryString }) => DynamicTablePickerPlugin({ queryString })}
              />
              <ListMaxIndentLevelPlugin maxDepth={7} />
              <TypingPerfPlugin />
              <TabFocusPlugin />
              {enableIndexedDBPersistence && <IndexedDBPersistencePlugin storageKey={persistenceKey} />}
              ...
              <div className="border-t border-border/70 bg-muted/20 px-4 py-3 text-sm">
                ...
                <div className="hidden flex-wrap items-center justify-between gap-3 md:flex">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <ImportExportPlugin />
                    <ShareContentPlugin />
                    <MarkdownTogglePlugin transformers={MARKDOWN_TRANSFORMERS} shouldPreserveNewLinesInMarkdown />
                    <TreeViewPlugin />
